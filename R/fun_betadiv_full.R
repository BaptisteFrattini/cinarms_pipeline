#' beta diversity decomposition with full comparisons
#'
#' @param metadata_data_mean data
#' @return the path to the subseted raw data file
#' @export

beta_div_decomp_full <- function(metadata_data_mean){
  ...
  df.turn$comp_imm <- ifelse(df.turn$col == "CINA1" & df.turn$row == "CINA2", "six_one",
                             ifelse(df.turn$col == "CINA3" & df.turn$row == "CINA4", "six_one",
                                    ifelse(df.turn$col == "CINA1" & df.turn$row == "CINA4", "six_one",
                                           ifelse(df.turn$col == "CINA3" & df.turn$row == "CINA2", "six_one",
                                                  ifelse(df.turn$col == "CINA2" & df.turn$row == "RUNA2", "one_two",
                                                         ifelse(df.turn$col == "CINA4" & df.turn$row == "RUNA2", "one_two",
  ...
  df.nest$comp_imm <- ifelse(df.nest$col == "CINA1" & df.nest$row == "CINA2", "six_one",
                             ifelse(df.nest$col == "CINA3" & df.nest$row == "CINA4", "six_one",
                                    ifelse(df.nest$col == "CINA1" & df.nest$row == "CINA4", "six_one",
                                           ifelse(df.nest$col == "CINA3" & df.nest$row == "CINA2", "six_one",
                                                  ifelse(df.nest$col == "CINA2" & df.nest$row == "RUNA2", "one_two",
                                                         ifelse(df.nest$col == "CINA4" & df.nest$row == "RUNA2", "one_two",
  ...
  df.jacc$comp_imm <- ifelse(df.jacc$col == "CINA1" & df.jacc$row == "CINA2", "six_one",
                             ifelse(df.jacc$col == "CINA3" & df.jacc$row == "CINA4", "six_one",
                                    ifelse(df.jacc$col == "CINA1" & df.jacc$row == "CINA4", "six_one",
                                           ifelse(df.jacc$col == "CINA3" & df.jacc$row == "CINA2", "six_one",
                                                  ifelse(df.jacc$col == "CINA2" & df.jacc$row == "RUNA2", "one_two",
                                                         ifelse(df.jacc$col == "CINA4" & df.jacc$row == "RUNA2", "one_two",
  ...
  df.turn$comp_deploy <- ifelse(df.turn$col == "CINA1" & df.turn$row == "CINA3", "deployment_hot_cool",
                                ifelse(df.turn$col == "CINA2" & df.turn$row == "CINA4", "deployment_hot_cool",
                                       ifelse(df.turn$col == "CINA1" & df.turn$row == "CINA4", "deployment_hot_cool",
                                              ifelse(df.turn$col == "CINA2" & df.turn$row == "CINA3", "deployment_hot_cool",
                                                     ifelse(df.turn$col == "RUNA2" & df.turn$row == "CINA3", "deployment_hot_cool",
                                                            ifelse(df.turn$col == "RUNA2" & df.turn$row == "CINA4", "deployment_hot_cool",
  ...
  df.nest$comp_deploy <- ifelse(df.nest$col == "CINA1" & df.nest$row == "CINA3", "deployment_hot_cool",
                                ifelse(df.nest$col == "CINA2" & df.nest$row == "CINA4", "deployment_hot_cool",
                                       ifelse(df.nest$col == "CINA1" & df.nest$row == "CINA4", "deployment_hot_cool",
                                              ifelse(df.nest$col == "CINA2" & df.nest$row == "CINA3", "deployment_hot_cool",
                                                     ifelse(df.nest$col == "RUNA2" & df.nest$row == "CINA3", "deployment_hot_cool",
                                                            ifelse(df.nest$col == "RUNA2" & df.nest$row == "CINA4", "deployment_hot_cool",
  ...
  df.jacc$comp_deploy <- ifelse(df.jacc$col == "CINA1" & df.jacc$row == "CINA3", "deployment_hot_cool",
                                ifelse(df.jacc$col == "CINA2" & df.jacc$row == "CINA4", "deployment_hot_cool",
                                       ifelse(df.jacc$col == "CINA1" & df.jacc$row == "CINA4", "deployment_hot_cool",
                                              ifelse(df.jacc$col == "CINA2" & df.jacc$row == "CINA3", "deployment_hot_cool",
                                                     ifelse(df.jacc$col == "RUNA2" & df.jacc$row == "CINA3", "deployment_hot_cool",
                                                            ifelse(df.jacc$col == "RUNA2" & df.jacc$row == "CINA4", "deployment_hot_cool",
  ...
  ggpubr::ggqqplot(df_deploy$turn) #QQplot presque OK
  shapiro.test(df_deploy$turn) #Shapiro presque OK 
  
  p.sed <- rstatix::t_test(df_deploy, turn ~ comp_deploy)
  p.sed <- rstatix::add_y_position(test = p.sed, step.increase = 0.3)
  ...
  ggplot(df_deploy, aes(x=nest)) + 
    geom_density() #Données approximativement normales (biaisé)
  ...
  ggpubr::ggqqplot(df_deploy$jacc) #QQplot OK
  ...
  path_to_boxplot_full <- paste0("outputs/beta/boxplot_beta_full.pdf")
  ggsave(filename =  path_to_boxplot_full, plot = fin, width = 15, height = 13.5)
  
  return(path_to_boxplot_full)
